...
TEST_F(LoafrModelTest, VerifyOutputFileContent) {
  ...
  std::string fileContentStr((std::istreambuf_iterator<char>(outFile)),
  ...
  std::string jsonStr =
      R"([ { "Component Name": "Component1", "Data Field Name": "Field1", "Data Value": "Value1", "Event Type": "Event1", "Timestamp": "2023-01-01" }, { "Component Name": "Component2", "Data Field Name": "Field2", "Data Value": "Value2", "Event Type": "Event2", "Timestamp": "2023-01-02" } ])";
