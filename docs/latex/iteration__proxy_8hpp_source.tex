...
\hypertarget{iteration__proxy_8hpp_source}{}\label{iteration__proxy_8hpp_source}\index{/Users/joeylangevin/Desktop/5801/P4/LoafrSystem/src/nlohmann/detail/iterators/iteration\_proxy.hpp@{/Users/joeylangevin/Desktop/5801/P4/LoafrSystem/src/nlohmann/detail/iterators/iteration\_proxy.hpp}}
...
\DoxyCodeLine{00030\ \textcolor{keywordtype}{void}\ int\_to\_string(\ string\_type\&\ target,\ std::size\_t\ \mbox{\hyperlink{namespacedetail_a47b1bb0bbd3596589ed9187059c312efa2063c1608d6e0baf80249c42e2be5804}{value}}\ )}
\DoxyCodeLine{00031\ \{}
\DoxyCodeLine{00032\ \ \ \ \ \textcolor{comment}{//\ For\ ADL}}
\DoxyCodeLine{00033\ \ \ \ \ \textcolor{keyword}{using\ }std::to\_string;}
\DoxyCodeLine{00034\ \ \ \ \ target\ =\ to\_string(\mbox{\hyperlink{namespacedetail_a47b1bb0bbd3596589ed9187059c312efa2063c1608d6e0baf80249c42e2be5804}{value}});}
\DoxyCodeLine{00035\ \}}
...
\DoxyCodeLine{00040\ \ \ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{value\_type}}\ =\ \mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{iteration\_proxy\_value}};}
...
\DoxyCodeLine{00065\ \ \ \ \ \{\}}
\DoxyCodeLine{00066\ }
\DoxyCodeLine{00067\ \ \ \ \ \mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{iteration\_proxy\_value}}(\mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{iteration\_proxy\_value}}\ \textcolor{keyword}{const}\&)\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00068\ \ \ \ \ \mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{iteration\_proxy\_value}}\&\ operator=(\mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{iteration\_proxy\_value}}\ \textcolor{keyword}{const}\&)\ =\ \textcolor{keywordflow}{default};}
...
\DoxyCodeLine{00070\ \ \ \ \ \mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{iteration\_proxy\_value}}(\mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{iteration\_proxy\_value}}\&\&)}
...
\DoxyCodeLine{00076\ \ \ \ \ \mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{\string~iteration\_proxy\_value}}()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00077\ }
\DoxyCodeLine{00079\ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classdetail_1_1iteration__proxy__value}{iteration\_proxy\_value}}\&\ \mbox{\hyperlink{classdetail_1_1iteration__proxy__value_a54d22aec1f615a38697466817d7cc819}{operator*}}()\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00154\ \};}
\DoxyCodeLine{00155\ }
\DoxyCodeLine{00157\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ IteratorType>\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classdetail_1_1iteration__proxy}{iteration\_proxy}}}
\DoxyCodeLine{00158\ \{}
...
\DoxyCodeLine{00164\ \ \ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classdetail_1_1iteration__proxy}{iteration\_proxy}}()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00165\ }
...
\DoxyCodeLine{00178\ \ \ \ \ \{}
\DoxyCodeLine{00179\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ iteration\_proxy\_value<IteratorType>(container-\/>begin());}
\DoxyCodeLine{00180\ \ \ \ \ \}}
\DoxyCodeLine{00181\ }
\DoxyCodeLine{00183\ \ \ \ \ iteration\_proxy\_value<IteratorType>\ \mbox{\hyperlink{classdetail_1_1iteration__proxy_a1037b697552341a5697fa15ee95250d1}{end}}()\ const\ noexcept}
\DoxyCodeLine{00184\ \ \ \ \ \{}
\DoxyCodeLine{00185\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ iteration\_proxy\_value<IteratorType>(container-\/>end());}
\DoxyCodeLine{00186\ \ \ \ \ \}}
\DoxyCodeLine{00187\ \};}
\DoxyCodeLine{00188\ }
