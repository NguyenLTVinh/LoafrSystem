...
\hypertarget{output__adapters_8hpp_source}{}\label{output__adapters_8hpp_source}\index{/Users/joeylangevin/Desktop/5801/P4/LoafrSystem/src/nlohmann/detail/output/output\_adapters.hpp@{/Users/joeylangevin/Desktop/5801/P4/LoafrSystem/src/nlohmann/detail/output/output\_adapters.hpp}}
...
\DoxyCodeLine{00034\ \ \ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{\string~output\_adapter\_protocol}}()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \ \ \ \ \mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00037\ \ \ \ \ \mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}\&)\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00038\ \ \ \ \ \mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}(\mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}\&\&)\ \textcolor{keyword}{noexcept}\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00039\ \ \ \ \ \mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}\&\ operator=(\textcolor{keyword}{const}\ \mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}\&)\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00040\ \ \ \ \ \mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}\&\ operator=(\mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}\&\&)\ \textcolor{keyword}{noexcept}\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00041\ \};}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00044\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ CharType>}
\DoxyCodeLine{00045\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacedetail_a160eb5d333fe01b259af32d3d4798a7b}{output\_adapter\_t}}\ =\ std::shared\_ptr<output\_adapter\_protocol<CharType>>;}
\DoxyCodeLine{00046\ }
...
\DoxyCodeLine{00049\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classdetail_1_1output__vector__adapter}{output\_vector\_adapter}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{structdetail_1_1output__adapter__protocol}{output\_adapter\_protocol}}<CharType>}
\DoxyCodeLine{00050\ \{}
\DoxyCodeLine{00051\ \ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00052\ \ \ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classdetail_1_1output__vector__adapter}{output\_vector\_adapter}}(std::vector<CharType,\ AllocatorType>\&\ vec)\ noexcept}
...
\DoxyCodeLine{00077\ \ \ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classdetail_1_1output__stream__adapter}{output\_stream\_adapter}}(std::basic\_ostream<CharType>\&\ s)\ noexcept}
...
\DoxyCodeLine{00102\ \ \ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classdetail_1_1output__string__adapter}{output\_string\_adapter}}(StringType\&\ s)\ noexcept}
...
\DoxyCodeLine{00126\ \ \ \ \ \mbox{\hyperlink{classdetail_1_1output__adapter}{output\_adapter}}(std::vector<CharType,\ AllocatorType>\&\ vec)}
\DoxyCodeLine{00127\ \ \ \ \ \ \ \ \ :\ oa(std::make\_shared<output\_vector\_adapter<CharType,\ AllocatorType>>(vec))\ \{\}}
\DoxyCodeLine{00128\ }
\DoxyCodeLine{00129\ \textcolor{preprocessor}{\#ifndef\ JSON\_NO\_IO}}
\DoxyCodeLine{00130\ \ \ \ \ \mbox{\hyperlink{classdetail_1_1output__adapter}{output\_adapter}}(std::basic\_ostream<CharType>\&\ s)}
\DoxyCodeLine{00131\ \ \ \ \ \ \ \ \ :\ oa(std::make\_shared<output\_stream\_adapter<CharType>>(s))\ \{\}}
\DoxyCodeLine{00132\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ JSON\_NO\_IO}}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00134\ \ \ \ \ \mbox{\hyperlink{classdetail_1_1output__adapter}{output\_adapter}}(StringType\&\ s)}
\DoxyCodeLine{00135\ \ \ \ \ \ \ \ \ :\ oa(std::make\_shared<output\_string\_adapter<CharType,\ StringType>>(s))\ \{\}}
\DoxyCodeLine{00136\ }
\DoxyCodeLine{00137\ \ \ \ \ \textcolor{keyword}{operator}\ output\_adapter\_t<CharType>()}
\DoxyCodeLine{00138\ \ \ \ \ \{}
\DoxyCodeLine{00139\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ oa;}
\DoxyCodeLine{00140\ \ \ \ \ \}}
\DoxyCodeLine{00141\ }
\DoxyCodeLine{00142\ \ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00143\ \ \ \ \ output\_adapter\_t<CharType>\ oa\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00144\ \};}
\DoxyCodeLine{00145\ }
