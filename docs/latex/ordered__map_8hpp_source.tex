...
\hypertarget{ordered__map_8hpp_source}{}\label{ordered__map_8hpp_source}\index{/Users/joeylangevin/Desktop/5801/P4/LoafrSystem/src/nlohmann/ordered\_map.hpp@{/Users/joeylangevin/Desktop/5801/P4/LoafrSystem/src/nlohmann/ordered\_map.hpp}}
...
\DoxyCodeLine{00046\ \ \ \ \ \mbox{\hyperlink{structordered__map}{ordered\_map}}()\ \textcolor{keyword}{noexcept}(\textcolor{keyword}{noexcept}(Container()))\ :\ Container\{\}\ \{\}}
\DoxyCodeLine{00047\ \ \ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{structordered__map}{ordered\_map}}(\textcolor{keyword}{const}\ Allocator\&\ alloc)\ \textcolor{keyword}{noexcept}(\textcolor{keyword}{noexcept}(Container(alloc)))\ :\ Container\{alloc\}\ \{\}}
\DoxyCodeLine{00048\ \ \ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ It>}
\DoxyCodeLine{00049\ \ \ \ \ \mbox{\hyperlink{structordered__map}{ordered\_map}}(It\ first,\ It\ last,\ \textcolor{keyword}{const}\ Allocator\&\ alloc\ =\ Allocator())}
\DoxyCodeLine{00050\ \ \ \ \ \ \ \ \ :\ Container\{first,\ last,\ alloc\}\ \{\}}
\DoxyCodeLine{00051\ \ \ \ \ \mbox{\hyperlink{structordered__map}{ordered\_map}}(std::initializer\_list<value\_type>\ init,\ \textcolor{keyword}{const}\ Allocator\&\ alloc\ =\ Allocator()\ )}
